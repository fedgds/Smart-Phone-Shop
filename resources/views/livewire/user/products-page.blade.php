      ...
      <div class="flex flex-wrap mb-24 -mx-3">
        ...
        <div class="w-full px-3 lg:w-3/4">
          ...
          <div class="mt-4 text-center">
            @if (count($products) >= 9)
                <button wire:loading.remove wire:click='loadMore' class="py-1 px-4 bg-blue-500 text-white rounded-lg hover:bg-red-600 mb-3">Xem thêm</button>
                <button wire:loading wire:click='loadMore' class="py-1 px-4 bg-blue-500 text-white rounded-lg hover:bg-red-600 mb-3">Đang load...</button>
            @endif
          </div>
        </div>
      </div>
