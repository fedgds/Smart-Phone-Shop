<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="py-10 bg-gray-50 font-poppins dark:bg-gray-800 rounded-lg p-4">
      <h1 style="font-family: cursive" class="text-center mb-8 text-5xl text-blue-600">Chi tiết đơn hàng</h1>
      <!-- Grid -->
        ...
        <div class="md:w-3/4">
            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                <tr wire:key="53">
                  ...
                  <td class="py-4">{{ number_format($item->unit_price) }} đ</td>
                  <td class="py-4">
                    <span class="text-center w-8">{{ $item->quantity }}</span>
                  </td>
                  <td class="py-4">{{ number_format($item->total_price) }} đ</td>
                </tr>
                @endforeach
              </tbody>
            </table>
          ...
          <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
            ...
            <div class="flex justify-between items-center">
              ...
              <div>
                <p class="font-semibold">Số điện thoại: {{ $order->phone_number }}</p>
              </div>
            </div>
          </div>
        ...
        <div class="md:w-1/4">
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-between mb-2">
              <span>Tổng tiền</span>
              <span>{{ number_format($order->grand_total) }} đ</span>
            </div>
            <div class="flex justify-between mb-2">
              <span>Thuế</span>
              <span>0 đ</span>
            ...
            <div class="flex justify-between mb-2">
              ...
              <span class="font-semibold">{{ number_format($order->grand_total) }} VND</span>
            </div>
