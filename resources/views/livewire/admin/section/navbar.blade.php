    ...
    <ul class="mt-4">
        ...
        <li class="mb-1 group">
            ...
            <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                <li class="mb-4">
                    <a href="/admin/voucher" class="text-gray-300 text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Voucher</a>
                </li>
            </ul>
        </li>
